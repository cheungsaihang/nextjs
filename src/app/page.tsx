    ...
    return (
        <div className="container mx-auto px-2">
            ...
            <div className="mt-5">
                ...
                <br />
                <p className="pb-4">Vercel's architecture is built around Jamstack, and deployments are handled through Git repositories. Vercel is a member of the MACH Alliance.</p>
                <br />
                ...
                <p className="pb-4">In 2016, Nicolás Garro (aka Evil Rabbit) joined ZEIT as the Founding Designer and Head of Design. ZEIT was rebranded to Vercel in April 2020, although retained the company's triangular logo.</p>
